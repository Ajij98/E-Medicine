...
<!-- Select particular shop details -->
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $tmp               = md5(time());
         $pescription_image = $_FILES["pescription_image"]["name"];
         $dst               = "./pescription_images/".$tmp.$pescription_image;
         $dst_db            = "pescription_images/".$tmp.$pescription_image;
         move_uploaded_file($_FILES["pescription_image"]["tmp_name"],$dst);
         

         $sql = "INSERT INTO tb_order_medicine(order_code,customer_name,email,phone,address,shop_id,shop_name,shop_code,shop_address,shop_image,medicine,pescription_image,order_date,order_by,shop_owner,entry_time)values('$order_code','$customer_name','$email','$phone','$address','$shop_id','$shop_name','$shop_code','$shop_address','$shop_image','$medicine','$dst_db','$order_date','$order_by','$shop_owner','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             window.alert("Your order request has been sent successfully. It will take a little while to aprove your order. Thank You!");
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
                            ...
                            <div class="col-md-6">
                                <div class="product-details">
                                    ...
                                    <div class="product-details-action">
                                        <a href="#available_medicine" class="scroll-to btn-product btn-cart mb-2 mt-2"><span>Buy Medicine</span></a>

                                        <a href="shop_review.php?shop_id=<?php echo $shop_id; ?>" class="btn btn-outline-success ml-3 mb-2 mt-2" style="padding-top: 12px; padding-bottom: 12px;"><span><i class="fa fa-star-o" aria-hidden="true"></i>Add Review</span></a>
            ...
            <hr>
            <h2 class="title text-center mt-4 mb-4" id="available_medicine"><span class="text-danger">**</span>Please filled-up to order medicine<span class="text-danger">**</span></h2><!-- End .title text-center -->


            <div class="page-content">

                <div class="container shadow-lg px-4 py-4" style="border-radius: 5px;">
                    <div class="product-details-top">
                        <div class="row">

                          <div class="col-9 m-auto">
 
                            <form class="px-4 py-4 mt-4 mb-4" action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                  <div class="row">
                                    <div class="col-sm-6">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                            ...
                                            <input type="text" name="shop_address"  class="form-control" value="<?php echo $shop_location; ?>" readonly>

                                            <label>Medicine * <small>(Type your medicine here, which you want to buy.)</small></label>
                                  <textarea class="form-control" name="medicine" rows="2"></textarea>

                                  ___OR___<br>

                                  <label>Upload Pescription Image *</label>
                                            <input type="file" name="pescription_image"  class="form-control">
