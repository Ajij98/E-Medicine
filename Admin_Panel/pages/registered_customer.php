...
<head>
  ...
  <title>Grand Health | Registered Customer</title>
...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="registered_customer.php" class="nav-link active">
              <i class="nav-icon fas fa-user"></i>
              <p>
                Registered Customer
              </p>
                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php while($result = $read_user->fetch_assoc()){ $i = $i + 1; ?>
                      <tr>
                          <td class="text-success" style="font-weight: bold;"><?php echo "Customer Id-".$result['user_id']; ?></td>
                          ...
                          <td>
                            <a href="delete_customer.php?user_id=<?php echo $result['user_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                      <?php }else{ ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2021 <a href="../index.php">Grand Health</a>.</strong>
    All rights reserved.
