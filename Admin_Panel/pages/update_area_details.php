  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         $area_name = $_POST['area_name'];
          ...
          $sql = "UPDATE tb_area SET area_name='$area_name' WHERE area_id = $area_id";
...
<head>
  ...
  <title>Grand Health | Update Area Details</title>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                    <div class="form-group">
                      ...
                      <div>
                        <input type="text" class="form-control" name="area_name" placeholder="Enter area name" value="<?php echo $area_name; ?>" required>
                      </div>
                    </div>
