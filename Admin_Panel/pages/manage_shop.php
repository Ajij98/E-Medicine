                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="<?php echo "../../Shop_Owner_Panel/pages/".$result['shop_image']; ?>" height="100" alt="shop_img"></td>
                      ...
                      <td>
                                            <?php
                                               ...
                                               if($shop_verify_status == 1)
                                               {
                                                ...
                                                {
                                                  ?>
                                                    <a href="shop_activation.php?shop_id=<?php echo $result['shop_id']; ?>" onclick="return confirm('Sure to active shop?')" class="btn btn-success btn-rounded btn-sm" >Make Active</a>
                                                  <?php
                                                }
                                             ?>
                                         </td>
                      <td>
                        <a href="delete_data.php?shop_id=<?php echo $result['shop_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
