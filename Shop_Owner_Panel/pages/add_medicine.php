<?php
 ...
 <?php
   ...
   if(isset($_POST['submit']))
   {
         ...
         $medicine_added_date   = $_POST['medicine_added_date'];
         $medicine_code         = rand(100000, 999999);
         ...
         $sql = "INSERT INTO tb_medicine(name,phone,shop_id,shop_code,shop_name,shop_location_details,medicine_name,medicine_type,medicine_price,medicine_image,medicine_added_date,shop_owner,entry_time)values('$name','$phone','$shop_id','$shop_code','$shop_name','$shop_location_details','$medicine_name','$medicine_type','$medicine_price','$dst_db','$medicine_added_date','$shop_owner','$current_datetime')";
         ...
         if($insert_row)
         {
           ...
           <script type="text/javascript">
             ...
             window.location='add_medicine.php?shop_id=<?php echo $shop_id; ?>';
           </script>
...
<head>
  ...
  <title>Grand Health | Add Medicine</title>
                  ...
                  <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <div class="form-row">
                        <div class="form-group col-lg-6">
                          ...
                          <input type="text" class="form-control" id="medicine_name" name="medicine_name" placeholder="Enter Medicine Name"  name="medicine_name" required>
                        </div>
                        <div class="form-group col-lg-6">
                      ...
                      <div class="form-row">
                        <div class="form-group col-lg-6">
                          ...
                          <input type="number" class="form-control" id="medicine_price" name="medicine_price" placeholder="Enter Medicine Price" required>
                        </div>
                        <div class="form-group col-lg-6">
                          <label for="medicine_image">Medicine Image *</label>
                          <input type="file" class="form-control" id="medicine_image" name="medicine_image" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group col-lg-6">
                          ...
                          <input type="date" class="form-control" id="medicine_added_date" name="medicine_added_date" required>
                      </div>

                      <div class="form-group">
                        <input type="submit" name="submit" class="btn btn-primary" value="Add Medicine">
                      </div>
