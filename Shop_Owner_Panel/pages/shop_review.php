    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="shop_review.php" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Shop Review</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td class="text-success"><?php echo "Review Id-".$result['review_id']; ?></td>
                      <td><?php echo "Shop Id-".$result['shop_id']; ?></td>
                      <td><?php echo $result['shop_name']; ?></td>
                      <td><?php echo $result['shop_code']; ?></td>
                      <td><?php echo $result['rating_value'].", Star"; ?></td>
                      <td><input type="text" name="comment" value="<?php echo $result['comment']; ?>"></td>
                      <td><?php echo $result['reviewed_by']; ?></td>
                      <td><?php echo $result['entry_time']; ?></td>
                      <td>
                        <a href="delete_data.php?review_id=<?php echo $result['review_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete review?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
