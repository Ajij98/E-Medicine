...
<!-- Medicine table data load -->
 <?php
   ...
   if(isset($_GET['shop_id']))
   {
     ...
     $db        = new Database();
     $sql       = "SELECT * FROM tb_medicine WHERE shop_id = $shop_id AND shop_owner = '$user_name'";
...
<head>
  ...
  <title>Grand Health | View Medicine Details</title>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <?php if($read_medicine){ $i = 0; ?>
                    <?php while($result = $read_medicine->fetch_assoc()){ $i = $i + 1; ?>
                    <tr>
                      <td><?php echo "Medicine Id-".$result['medicine_id']; ?></td>
                      <td><img src="<?php echo $result['medicine_image']; ?>" height="100" alt="medicine_img"></td>
                      <td><?php echo $result['medicine_name']; ?></td>
                      <td><?php echo $result['medicine_type']; ?></td>
                      <td><?php echo "Tk. ".$result['medicine_price']; ?></td>
                      <td><?php echo "Shop Id-".$result['shop_id']; ?></td>
                      <td><?php echo $result['shop_name']; ?></td>
                      <td><?php echo $result['shop_location_details']; ?></td>
                      <td><?php echo $result['medicine_added_date']; ?></td>
                      <td>
                        <a href="update_medicine_details.php?medicine_id=<?php echo $result['medicine_id']; ?>&shop_id=<?php echo $shop_id; ?>" title="update" class="btn btn-info btn-sm waves-effect waves-light"><i class="fa fa-pencil"></i></a> || <a href="delete_medicine.php?medicine_id=<?php echo $result['medicine_id']; ?>&shop_id=<?php echo $shop_id; ?>" title="delete" onclick="return confirm('Are you sure to delete?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
