  ...
  <?php
   ...
   if(isset($_POST['update']))
   {
         ...
         if($shop_image != "")
         {
           ...
           $sql = "UPDATE tb_shop SET name='$name',email='$email',phone='$phone',shop_name='$shop_name',about_shop='$about_shop',shop_location='$shop_location',shop_location_details='$shop_location_details',shop_image='$dst_db',shop_added_date='$shop_added_date',shop_oc_time='$shop_oc_time',shop_contact='$shop_contact' WHERE shop_id = $shop_id";

           $update_row = $db->update($sql);
         }


          $sql = "UPDATE tb_shop SET name='$name',email='$email',phone='$phone',shop_name='$shop_name',about_shop='$about_shop',shop_location='$shop_location',shop_location_details='$shop_location_details',shop_added_date='$shop_added_date',shop_oc_time='$shop_oc_time',shop_contact='$shop_contact' WHERE shop_id = $shop_id";
...
<head>
  ...
  <title>Grand Health | Update Shop Details</title>
