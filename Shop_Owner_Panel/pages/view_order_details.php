...
<head>
  ...
  <title>MEDiShop | View Order Details</title>
        ...
        <div class="card card-primary">
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <p class="text-success" style="font-weight: bold;">Order Id: Order Id-1</p>
                  <p>Order Code: 330245</p>
                  <p>Ordered Medicine: Napa Extra(1 pata), Exium 20(1 pata), Osartil 50 Plus(1 pata)</p>
                  <p>Order Date: 19-06-2021</p>                    
                  <p>Shop Id: Shop Id-1</p>
                  <p>Shop Name: Laz Pharma</p>
                  <p>Shop Address: Agrabad, #Ziaul Haque Market, #3rd Floor, #Shop No-3</p>
                  <p>Customer Name: Md Parvez</p>
                  <p>Customer Phone: 01875482555</p>
                  <p>Customer Address: Agrabad</p>
