                ...
                <div class="card-body">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="add_medicine.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-success btn-rounded btn-sm">Add Medicine</a>
                      </td>
                      <td>
                        <a href="view_medicine_details.php?shop_id=<?php echo $result['shop_id']; ?>" class="btn btn-secondary btn-rounded btn-sm">View Medicine</a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
