...
<head>
  ...
  <title>Grand Health | Customer Order</title>
              ...
              <!-- form start -->
                <div class="card-body">
                  ...
                  <tr>
                    <tr>
                      <th>Order Id</th>
                      <th>Order Verify Code</th>
                      <th>Ordered Medicine / Pescription Image</th>
                      <th>Order Date</th>
                      <th>Customer Name</th>
                  ...
                  <tbody>
                    ...
                    <?php if($read_customer_order){ $i = 0; ?>
                    <?php while($result = $read_customer_order->fetch_assoc()){ $i = $i + 1; ?>
                    <tr>
                      ...
                      <td>
                        <?php
                            ...
                            {
                              ?>
                                <a href="order_confirmation.php?order_id=<?php echo $result['order_id']; ?>" onclick="return confirm('Sure to confirm order?')" class="btn btn-success btn-rounded btn-sm" >Confirm Order</a>
                              <?php
                            }
                          ?>
                     </td>
                      <td>
                        <a href="delete_data.php?order_id=<?php echo $result['order_id']; ?>" title="delete" onclick="return confirm('Are you sure to delete order?')" class="btn btn-danger btn-sm btn-round waves-effect waves-light"><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>
                    <?php } ?>
                    <?php }else{ ?>
