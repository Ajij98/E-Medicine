<?php
 ...
 <?php
   ...
   $db        = new Database();
   $sql       = "SELECT * FROM tb_shop_payment WHERE owner_user_name = '$user_name'";
...
<head>
  ...
  <title>Grand Health | Shop Payment History</title>
                    ...
                    <?php if($read_shop_payment){ $i = 0; ?>
                      <?php while($result = $read_shop_payment->fetch_assoc()){ $i = $i + 1; ?>
                        <tr>
                          ...
                          <td><img src="<?php echo $result['payment_ss']; ?>" alt="payment_ss" height="100"></td>
                          ...
                          <td>
                                        ...
                                        <td>
                                          <a onclick="return confirm('Sure to delete?')" href="delete_data.php?payment_id=<?php echo $result['payment_id']; ?>" title="delete" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
                                        </td>
                        </tr>
                        <?php } ?>
                        <?php }else{ ?>
